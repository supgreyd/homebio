                        ...
                        <div class="cabinet-section">
                            ...
                            <div class="notifications-settings">
                                <label class="toggle-switch">
                                    ...
                                    $is_enabled = $email_enabled !== 'disabled';
                                    ?>
                            ...
                            <?php else : ?>
                                <div class="notifications-empty">
                                    ...
                                    <h3><?php esc_html_e('No notifications yet', 'homebio'); ?></h3>
                                    <p><?php esc_html_e('When properties in your favorites are updated, you\'ll see notifications here.', 'homebio'); ?></p>
                                    <a href="<?php echo esc_url(get_post_type_archive_link('property')); ?>" class="btn btn-primary">
                                        <?php esc_html_e('Browse Properties', 'homebio'); ?>
                                    </a>
                                </div>
